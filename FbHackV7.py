...
\033[1;96m ██ ██       VIP-V3 by Mr.Thunder                   
\033[1;93m╔═══════════════════════════════════════════╗
...
def an():
    ...
    try:
        ...
        print logo
        time.sleep(1)
        print 'Silahkankan Login Terlebih Dahulu Di Opera Mini.... !!'
        time.sleep(3)
        print 'Untuk Menghindari CheckPoint...!!'
        time.sleep(3)
        print 'Dan Hapus Data FB Lite Nya Thanks'
        time.sleep(3)
